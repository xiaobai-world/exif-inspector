...
function readIPTCData(file: ArrayBuffer, startOffset: number, sectionLength: number) {
  var dataView = new DataView(file);
  var data: any = {};
  var fieldValue, fieldName, dataSize, segmentType: keyof typeof IptcFieldMap, segmentSize;
...
function readTags(file: DataView, tiffStart: number, dirStart: number, strings: any, bigEnd: boolean) {
    ...
    case 5:    // rational = two long values, first is numerator, second is denominator
      if (numValues == 1) {
        ...
        for (n = 0; n < numValues; n++) {
          ...
          vals[n] = new Number(numerator / denominator) as any;
